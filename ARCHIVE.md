...
This page is a permanent record of every hackathon that has closed. These are kept here for reference — many hackathons run annually and may reopen next cycle.

> Back to active hackathons: [README](README.md)
...
| 🔒 **[CLOSED]** | JPMorgan Chase | 2027 Code for Good Hackathon — Brooklyn Oct 16–17 & Columbus Nov 6–7, 2026 (Leads to Software Engineer Program Internship) | In-Person | Brooklyn, NY, Columbus, OH | :lock: | Aug 09, 2026 |
...
| 🔒 **[CLOSED]** | Arya Health | Healthcare Hack NYC (Powered by Arya Health) | In-Person | New York, NY | :lock: | Jun 28, 2026 |
| 🔒 **[CLOSED]** | Cerebral Valley | The Future of Agentic AI in Healthcare (Abridge × Anthropic × Lightspeed) | In-Person | San Francisco, CA | :lock: | Jun 28, 2026 |
| 🔒 **[CLOSED]** | MIT | HackMIT 2026 (Weekend Hackathon; Open to Undergrads Worldwide) | In-Person | Cambridge, MA | :lock: | Jun 27, 2026 |
| 🔒 **[CLOSED]** | Major League Hacking | Global Hack Week: Season Launch — Jul 10–16, 2026 | Virtual | Online | :lock: | Jun 27, 2026 |
...
> :information_source: When a hackathon closes, it is moved here automatically. If you spot an event that has ended but is still listed as open in the [README](README.md), please open a **Close Hackathon** issue.
